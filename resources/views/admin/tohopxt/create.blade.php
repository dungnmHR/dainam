            ...
            <div class="col-4">
                ...
                @csrf
                    <div class="form-group">
	                      ...
	                      <input class="form-control" name="code" id="code" type="text" placeholder="A00">
                    </div>

                    <div class="form-group">
	                      <label for="job">Nội dung</label>
	                      <input class="form-control" name="content" id="content" type="text" placeholder="Toán-Lý-Hóa">
                    </div>
